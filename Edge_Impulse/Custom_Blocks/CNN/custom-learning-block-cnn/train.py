...
# model architecture
model = Sequential()
model.add(Reshape((24,3,1), input_shape = (72, ))) # reshape (72, ) to (24, 3, 1)
model.add(Conv2D(8, kernel_size=(4,1), kernel_constraint=tf.keras.constraints.MaxNorm(1), activation='relu'))
